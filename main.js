...
function updatedProductionCount() {
  ...
  var production_count = formatEggs((_premiumDragons * 60 * 60) + (_myIceDragons * 1 * 60 * 60 * 10) + _myUltraDragons * 1 * 60 * 60 * 25);
...
function updateSellForText() {
  ...
  getDragonSellPrice(eggs, function (price) {
	...
	sellsforexampledoc.textContent = "1 BNB = " + formatEggs(sellFor) + " Chicken eggs";
  });
...
function updateDragonButton() {
  ...
  getNumberOfDragons(eth, function (dragons) {
    // alert(eth, amount);
    dragons = dragons;
    premium.innerHTML = "Buy " + formatDragons(dragons) + " Cool Chickens <br> for " + parseFloat(premiumInput.value).toFixed(4) + " BNB";
  });
...
function updateIceDragonPrice() {
  ...
  getNumberOfDragons(eth, function (dragons) {
    dragons = dragons;
    document.getElementById("buyIceDragon").innerHTML = "Buy " + formatDragons(dragons / 8) + " Strong Chickens <br>for " + parseFloat(document.getElementById("buyIceDragonInput").value).toFixed(2) + " BNB";
  });
}
...
function updateUltraDragonPrice() {
  ...
  getNumberOfDragons(eth, function (dragons) {
    dragons = dragons;
    document.getElementById("buyUltraDragon").innerHTML = "Buy " + formatDragons(dragons / 20) + " Bestial Chickens <br>for " + parseFloat(document.getElementById("buyUltraDragonInput").value).toFixed(2) + " BNB";
  });
}
...
function refreshData() {
  ...
  const d = (_premiumDragons + _myIceDragons * 10 + _myUltraDragons * 25);
  if (d === 0) {
...
function setRef() {
  ...
  document.getElementById("playerreflink").innerHTML = 'http://ChickenEggFarm.fun/?ref=' + this.userAddress;
}

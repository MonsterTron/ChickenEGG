...
function updateSellForText() {
  ...
  getDragonSellPrice(eggs, function (price) {
	...
	sellsforexampledoc.textContent = "1 BNB = " + formatEggs(sellFor) + " Yoshi eggs";
  });
...
function updateDragonButton() {
  ...
  getNumberOfDragons(eth, function (dragons) {
    // alert(eth, amount);
    dragons = dragons;
    premium.innerHTML = "Buy " + formatDragons(dragons) + " Green Yoshis <br> for " + parseFloat(premiumInput.value).toFixed(4) + " BNB";
  });
...
function updateIceDragonPrice() {
  ...
  getNumberOfDragons(eth, function (dragons) {
    dragons = dragons;
    document.getElementById("buyIceDragon").innerHTML = "Buy " + formatDragons(dragons / 8) + " Blue Yoshis <br>for " + parseFloat(document.getElementById("buyIceDragonInput").value).toFixed(2) + " BNB";
  });
}
...
function updateUltraDragonPrice() {
  ...
  getNumberOfDragons(eth, function (dragons) {
    dragons = dragons;
    document.getElementById("buyUltraDragon").innerHTML = "Buy " + formatDragons(dragons / 20) + " Yellow Yoshis <br>for " + parseFloat(document.getElementById("buyUltraDragonInput").value).toFixed(2) + " BNB";
  });
}
